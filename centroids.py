...
for y in range(thresh.shape[0]):
	for x in range(thresh.shape[1]):
		...
		# Add the product of the distance squared and the pixel intensity to the moment of inertia
		I += d * thresh[y, x]

# Convert the moment of inertia to real units
I_real = I * conv**4
...
cv2.putText(img_c,"I: {:.2f}".format(I_real),(cx-50,cy-40),cv2.FONT_HERSHEY_SIMPLEX,0.6,(255,0,0),2)
